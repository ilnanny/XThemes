...
" GPL V2+ license
"
" @author Cristian Pozzessre < ilnanny >
scriptencoding utf8
" }}}
" vim:fdm=marker
...
"
" let s:noktomix.black = ['#000000', 0, 0]

let g:terminal_ansi_colors = [
            \ '#4B595E', '#CD6360', '#80B080', '#E1D682', '#81A1CF', '#BE93BE', '#67C3E4', '#CEDADE',
            \ '#4F5D61', '#964947', '#679267', '#CEB84D', '#6699CC', '#B893B8', '#57C4E2', '#CED8DB'
            \ ]
let s:i = 0
...
let s:noktomix.red    = ['#CD5959', 210,  1]
let s:noktomix.green  = ['#88BB88', 108,  2]
let s:noktomix.yellow = ['#F0C97A', 220,  3]
let s:noktomix.blue   = ['#608FCA',  32,  4]
let s:noktomix.purple = ['#9E89B3', 140,  5]
...
function! <SID>HighLight(GRP, FG, BG, ATT) abort  " {{{1
    if a:FG !=# ''
        let l:fg_col  = get(s:noktomix, a:FG)
    ...
    if a:BG !=# ''
        let l:bg_col  = get(s:noktomix, a:BG)
